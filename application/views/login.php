...
<body style="background-image: url('<?= base_url()?>/assets/assets_stisla/assets/img/pattern2.png')">
  <div id="app" >
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary" style="border: 1px solid grey">
              ...
              <div class="card-body">
                <form method="POST" action="<?=base_url('auth/process')?>" id="loginform" class="needs-validation" novalidate="">
